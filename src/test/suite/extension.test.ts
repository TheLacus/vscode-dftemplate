...
suite('Extension Test Suite', () => {
    ...
    test('DefinitionProvider', async () => {
        ...
        const testDefinitionProvider = async (position: vscode.Position, expectedPosition: Position) => {
        ...
        await testDefinitionProvider(new Position(16, 9), new Position(13, 9));
        await testDefinitionProvider(new Position(17, 12), new Position(11, 5));
        await testDefinitionProvider(new Position(18, 8), new Position(4, 10));
        await testDefinitionProvider(new Position(6, 34), new Position(11, 5));
    });

    test('ReferenceProvider', async () => {
        const provider = new TemplateReferenceProvider(quests);
        
        const testReferenceProvider = async (position: Position, ...expectedReferences: Position[]) => {
        ...
        await testReferenceProvider(new Position(6, 34), new Position(6, 34), new Position(17, 12));
        await testReferenceProvider(new Position(13, 9), new Position(16, 9));
    });
